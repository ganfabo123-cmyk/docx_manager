...
import tempfile
import requests
from full_style_docx_fixer.models.models import UserData, PageFooterConfig, TocEntry, Reference, Citation
...
class DataCollector:
    ...
    def get_full_config(self) -> Dict[str, Any]:
        ...
        # 读取现有配置文件
        config_path = Path(__file__).parent / 'full_style_docx_fixer' / 'utils' / 'user_config.json'
        base_config = {}
...
def create_app(default_output_path=None): # 1. 允许传入默认输出路径
    ...
    def save_to_disk():
        try:
            ...
            default_path = Path(__file__).parent / 'full_style_docx_fixer' / 'utils' / 'user_config.json'
    ...
    def generate_user_data():
        try:
            ...
            from docx_helper.api import process
